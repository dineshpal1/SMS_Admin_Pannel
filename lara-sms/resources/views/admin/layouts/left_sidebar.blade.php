      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class=""><a href="{{route('listclasssection')}}"><i class="fa fa-circle-o"></i>List Section</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class=""><a href="{{route('listfacultyTypes')}}"><i class="fa fa-circle-o"></i>List Faculty Type</a></li>
